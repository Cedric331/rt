            ...
            <div class="inline-block">
                <div class="inline-flex items-center max-w-full">
                    <button class="flex items-center flex-grow-0 flex-shrink pl-2 relative w-60 border rounded-full px-1  py-1" type="button">
                        <div class="block flex-grow flex-shrink overflow-hidden text-white">Recherche...</div>
                        <div class="flex items-center justify-center relative  h-8 w-8 rounded-full text-white">
                            <svg
                                viewBox="0 0 32 32"
                ...
                <div class="block">
                    <div class="inline relative">
                        <button type="button" class="inline-flex items-center relative px-2 border rounded-full hover:shadow-lg">
                            ...
                            <div class="block flex-grow-0 flex-shrink-0 h-10 w-12 pl-5 text-white">
                                <svg
                                    viewBox="0 0 32 32"
                                    xmlns="http://www.w3.org/2000/svg"
                                    aria-hidden="true"
