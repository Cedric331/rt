                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="sm:flex sm:items-start">
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            <h3 class="text-lg leading-6 font-medium text-gray-900 text-center" id="modal-title"><b>Nom de l'élément</b></h3>
                            <div class="mt-2 ">
<!--                                <p class="text-sm text-gray-500">-->
<!--                                    Veuillez taper le nom de l'élément-->
<!--                                </p>-->
                                <div class="flex justify-center">
                                    <div class="flex-shrink-0 flex items-center justify-center h-12 w-12 sm:mx-0 sm:h-10 sm:w-10">
