            ...
            <div class="max-w-7xl mx-auto">
                <div class="bg-white overflow-hidden shadow-sm">
                    ...
                    <div class="min-h-screen bg-slate-800">
                        <div class="transition ease-in-out delay-4000 min-h-screen w-[3.35rem] overflow-hidden border-r hover:w-56 hover:bg-slate-900 hover:shadow-lg">
                            <div class="flex h-screen flex-col justify-between pt-2 pb-6">
                                ...
                                <div class="w-max -mb-3">
                                    <div class="group flex items-center space-x-4 rounded-md px-4 py-3 text-gray-600">
